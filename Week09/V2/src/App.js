...
const App = () => {
  ...
  // calling use effect with an empty dependency array will only fire the function within
  ...
  const deleteTodoById = async (id) => {
    // no need to store the response because theres no helpful data in it
